...
public class XapiClient {
    ...
    public XapiResponse getStatements(String queryParams) throws Exception {
        // e.g., queryParams = "?verb=http://adlnet.gov/expapi/verbs/completed&limit=10"
        String url = config.getEndpoint() + "/statements";
